  ...
  const menureports = (
    <Menu>
      <Menu.ItemGroup title="Reports">
        <Menu.Item><a href="/reports">Registration</a></Menu.Item>
    ...
    <Row>
      ...
      > <a href="./">
        <Image
          ...
          alt="Header Image"
          src="https://qa.onlinexperiences.com/cfr/scripts/VXP/Reflow/WebcastLobby/assets/WCLobby-DefaultHeaderImage.png"
      ...
      <Col>
        <Dropdown overlay={menureports} arrow={true}>
          <a href="/reports" className="ant-dropdown-link" onClick={(e) => e.preventDefault()}>
            <AreaChartOutlined
              style={{
                fontSize: "200%",
        ...
        <Dropdown overlay={menu} arrow={true}>
          <a href="/settings" className="ant-dropdown-link" onClick={(e) => e.preventDefault()}>
            <SettingFilled
              style={{
                fontSize: "200%",
                verticalAlign: "middle",
